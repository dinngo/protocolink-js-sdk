...
export class PoolDataProvider__factory {
  static readonly abi = _abi;
  static createInterface(): PoolDataProviderInterface {
    return new utils.Interface(_abi) as PoolDataProviderInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): PoolDataProvider {
    return new Contract(address, _abi, signerOrProvider) as PoolDataProvider;
  }
}
