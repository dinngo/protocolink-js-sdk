...
import type { RewardsController, RewardsControllerInterface } from '../RewardsController';
...
export class RewardsController__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): RewardsController {
