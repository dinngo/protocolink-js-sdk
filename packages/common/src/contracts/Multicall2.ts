...
export interface Multicall2 extends BaseContract {
  ...
  functions: {
    aggregate(calls: Multicall2.CallStruct[], overrides?: Overrides & { from?: string }): Promise<ContractTransaction>;
  ...
  estimateGas: {
    aggregate(calls: Multicall2.CallStruct[], overrides?: Overrides & { from?: string }): Promise<BigNumber>;

    blockAndAggregate(calls: Multicall2.CallStruct[], overrides?: Overrides & { from?: string }): Promise<BigNumber>;
  ...
  populateTransaction: {
    aggregate(calls: Multicall2.CallStruct[], overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>;
